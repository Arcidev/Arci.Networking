...
namespace Arci.Networking.Tests.DataTests
{
    ...
    public class GuidTests : BaseTestClass
    {
        ...
        {
            var guid1 = new PacketGuid(guidValues[0]);
        ...
        {
            var guid1 = new PacketGuid(uint64Value);
            var guid2 = (PacketGuid)uint64Value;
